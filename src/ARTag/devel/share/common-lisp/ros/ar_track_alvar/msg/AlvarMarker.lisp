...
(cl:defmethod cl:initialize-instance :after ((m <AlvarMarker>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AlvarMarker)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ar_track_alvar-msg:<AlvarMarker> is deprecated: use ar_track_alvar-msg:AlvarMarker instead.")))
...
(cl:defmethod id-val ((m <AlvarMarker>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ar_track_alvar-msg:id-val is deprecated.  Use ar_track_alvar-msg:id instead.")
  (id m))

(cl:ensure-generic-function 'confidence-val :lambda-list '(m))
(cl:defmethod confidence-val ((m <AlvarMarker>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ar_track_alvar-msg:confidence-val is deprecated.  Use ar_track_alvar-msg:confidence instead.")
  (confidence m))

(cl:ensure-generic-function 'pose-val :lambda-list '(m))
(cl:defmethod pose-val ((m <AlvarMarker>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ar_track_alvar-msg:pose-val is deprecated.  Use ar_track_alvar-msg:pose instead.")
  (pose m))
