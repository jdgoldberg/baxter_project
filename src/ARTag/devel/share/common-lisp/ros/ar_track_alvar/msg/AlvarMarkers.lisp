...
(cl:in-package ar_track_alvar-msg)
...
(cl:defclass <AlvarMarkers> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (markers
    :reader markers
    :initarg :markers
    :type (cl:vector ar_track_alvar-msg:AlvarMarker)
   :initform (cl:make-array 0 :element-type 'ar_track_alvar-msg:AlvarMarker :initial-element (cl:make-instance 'ar_track_alvar-msg:AlvarMarker))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <AlvarMarkers>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AlvarMarkers)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ar_track_alvar-msg:<AlvarMarkers> is deprecated: use ar_track_alvar-msg:AlvarMarkers instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <AlvarMarkers>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ar_track_alvar-msg:header-val is deprecated.  Use ar_track_alvar-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'markers-val :lambda-list '(m))
(cl:defmethod markers-val ((m <AlvarMarkers>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ar_track_alvar-msg:markers-val is deprecated.  Use ar_track_alvar-msg:markers instead.")
  (markers m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <AlvarMarkers>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'markers)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'ar_track_alvar-msg:AlvarMarker))
